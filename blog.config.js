...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '56930b51df1e43dd8d4509e89fa054d5',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ANGI', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Per Aspera Ad Astra', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'ANGI.fit', // 网站地址
  ...
  WIDGET_PET_LINK: process.env.NEXT_PUBLIC_WIDGET_PET_LINK || 'https://unpkg.com/live2d-widget-model-hijiki@1.0.5/assets/hijiki.model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
  WIDGET_PET_SWITCH_THEME: false, // 点击宠物挂件切换博客
  ...
  ANALYTICS_BAIDU_ID: process.env.NEXT_PUBLIC_ANALYTICS_BAIDU_ID || 'e128123c7118eeda9af43378748dd157', // e.g 只需要填写百度统计的id，[baidu_id] -> https://hm.baidu.com/hm.js?[baidu_id]
